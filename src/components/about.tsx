      ...
      <DialogContent className="flex max-h-full flex-col sm:max-w-prose">
        ...
        <div className="prose-sm flex-1 overflow-y-auto py-4">
          ...
          <ul className="pl-0">
            ...
            <li>
              <a
                href="https://github.com/rayyan2006bd-coder"
                target="_blank"
                rel="noreferrer"
              >
                Rayyan Ahmed, 24 Series, Dept. of IPE, RUET
              </a>
            </li>
          </ul>
          <h2>Source code</h2>
          <p>
            ...
            meaning it's free to use, share, and adapt. The source code is
            available through{' '}
            <a
              href="https://github.com/rayyan2006bd-coder"
              target="_blank"
            ...
            >
              <GitHubLogoIcon className="inline" /> Rayyan Ahmed on GitHub
            </a>
            .
          </p>
          <p>
            The directory backend is also open source. It serves public teacher
            and department information for autocomplete while your student,
            course, and generated PDF data remain on this device.
          </p>
        </div>
      </DialogContent>
    </Dialog>
